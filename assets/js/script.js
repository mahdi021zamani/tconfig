<!DOCTYPE html><html lang="fa">
    <head>
        ...
        <link href="./assets/css/style.css?v1.4.3" rel="stylesheet" />
        ...
        <div class="container">
            <div class="col-lg-6 col-md-8 col-sm-12 col-xs-12 col-centered">
                ...
                <div class="alert alert-info" id="defAlert">
                    <p>توسط این‌ابزار می‌تونین به کانفیگ‌های رایگان گردآوری‌شده بر اساس لوکیشن دلخواه دسترسی داشته باشین. این‌کانفیگ‌ها به‌صورت خودکار و منظم، بدون دخل‌وتصرف از یه‌سری <a href="mahdi021zamani@gmail.com" target="_blank">کانال تلگرامی</a> جمع‌آوری میشن و برای رعایت مسائل امنیتی توصیه میشه تنها برای مصارف عادی ازشون استفاده کنین.</p>
                </div>
                <ul class="nav nav-pills">
                    <li><a href="https://tconfig.pages.dev/">پروتکل‌ها</a></li>
                    <li class="active"><a href="https://location-58t.pages.dev/">لوکیشن‌ها</a></li>
                </ul>
                    ...
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="alert alert-warning">بعد از اسکن کد کیوآر ممکنه توی بعضی‌از اپ‌ها به انجام «بروزرسانی اشتراک» نیاز باشه.</div>
                            </div>
                ...
                <footer>
                    <p class="text-center">
                        © توسط
                        <a href="mahdi021zamani@gmail.com" target="_blank">MAHDIZAMNI</a>،
                        به کمک
                        <a href="mahdi021zamani@gmail.com" target="_blank">CLOUDFLARE</a>
                    </p>
                    <script src="./assets/js/jquery.min.js"></script>
                    <script src="./assets/js/bootstrap.min.js"></script>
                    <script src="./assets/js/script.js?v1.5.1"></script>
                </footer>
            </div>
        </div>
    </body>
